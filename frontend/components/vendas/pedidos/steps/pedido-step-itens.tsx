...
import { PedidoAddItemQuick } from "../pedido-add-item-quick"
import { PedidoEditItemDialog } from "../pedido-edit-item-dialog"

interface PedidoStepItensProps {
...
export function PedidoStepItens({ form, addItem, updateItem, removeItem }: PedidoStepItensProps) {
  ...
  const handleSaveEdit = (item: ItemFormData) => {
  ...
  return (
    <div className="space-y-4">
      ...
      <PedidoAddItemQuick onAddItem={addItem} />
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription className="text-xs">
                Lista de produtos e serviços do pedido
              </CardDescription>
            </div>
            {itens.length > 0 && (
