...
interface NfseConfigFieldsProps {
  form: UseFormReturn<any>
  prefix: "Producao" | "Homologacao"
  showInutilizacao?: boolean
}

interface NfseInutilizacaoFieldsProps {
  form: UseFormReturn<any>
  prefix: "Producao" | "Homologacao"
}

export function NfseConfigFields({ form, prefix, showInutilizacao = true }: NfseConfigFieldsProps) {
  return (
...
export function NfseInutilizacaoFields({ form, prefix }: NfseInutilizacaoFieldsProps) {
  return (
    <div className="space-y-3">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
