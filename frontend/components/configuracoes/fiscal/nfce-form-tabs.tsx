...
interface NfceConfigFieldsProps {
  form: UseFormReturn<any>
  prefix: "Producao" | "Homologacao"
  showInutilizacao?: boolean
}

interface NfceInutilizacaoFieldsProps {
  form: UseFormReturn<any>
  prefix: "Producao" | "Homologacao"
}

export function NfceConfigFields({ form, prefix, showInutilizacao = true }: NfceConfigFieldsProps) {
  return (
...
export function NfceInutilizacaoFields({ form, prefix }: NfceInutilizacaoFieldsProps) {
  return (
    <div className="space-y-3">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
