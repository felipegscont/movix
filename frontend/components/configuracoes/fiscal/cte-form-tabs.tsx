...
interface CteConfigFieldsProps {
  form: UseFormReturn<any>
  prefix: "Producao" | "Homologacao"
  showInutilizacao?: boolean
}

interface CteInutilizacaoFieldsProps {
  form: UseFormReturn<any>
  prefix: "Producao" | "Homologacao"
}

export function CteConfigFields({ form, prefix, showInutilizacao = true }: CteConfigFieldsProps) {
  return (
...
export function CteInutilizacaoFields({ form, prefix }: CteInutilizacaoFieldsProps) {
  return (
    <div className="space-y-3">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
