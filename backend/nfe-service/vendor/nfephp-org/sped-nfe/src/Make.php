...
class Make
{
    ...
    public function taginfRespTec(stdClass $std): DOMElement
    {
        ...
        $this->dom->addChild(
            ...
            $std->xContato,
            true,
            "Informar o nome da pessoa a ser contatada na emitente desenvolvedora "
        ...
        $this->dom->addChild(
            ...
            $std->email,
            true,
            "Informar o e-mail da pessoa a ser contatada na emitente "
        ...
        $this->dom->addChild(
            ...
            $std->fone,
            true,
            "Informar o telefone da pessoa a ser contatada na emitente "
                . "desenvolvedora do sistema."
        );
